...
<head>
  ...
  <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Animation')); ?>
    ...
    <div class="main-content overflow-hidden">
      ...
      <div class="page-content">
        <div class="container-fluid">
          <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Advance UI', 'title' => 'Animation')); ?>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
