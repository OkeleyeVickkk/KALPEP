										...
										<div class="v-wrap col-12 col-sm-9 col-md-11 col-lg-9 mx-auto">
											...
											<form action="" class="v-form">
												...
												<div class="v-form-input">
													...
													<div class="position-relative">
														<input type="password" v-model="userAuth.password" class="form-control" id="password" placeholder="Enter your password" />
												...
												<div class="mt-2 text-center">
													<button type="submit" class="v-button" @click.prevent="loginUser" :disabled="loading.btn">
